...
export default function PaymentPage() {
  ...
  // Using camelCase 'clientId' to satisfy strict TypeScript definitions
      ...
      <div className="mx-auto max-w-xl">
        <div className="bg-white rounded-[48px] shadow-[0_40px_100px_-20px_rgba(0,31,63,0.15)] border border-slate-100 overflow-hidden">
          ...
          <div className="p-8 md:p-12 space-y-10">
            ...
            {/* STEP 3: PAYPAL GATEWAY */}
            <div className="pt-10 border-t border-slate-100">
              <PayPalScriptProvider
                options={{
                  clientId: clientId, // Fixes TS Property 'clientId' error
                  currency: "USD",
                  "enable-funding": "card",
                  "disable-funding": "paylater", // Removes Pay Later
                  intent: "capture",
                }}
              >
                <div
                        ...
                        purchase_units: [
                          {
                            ...
                            amount: {
                              currency_code: "USD", // Fixes TS Property 'currency_code' error
                              value: val,
                            },
                          },
                        ],
